...
import JBSelectBox from 'jb-selectbox-react/dist/JBSelectBox.min';
...
function () {
  ...
  _createClass$1(JBSearchBarService, [{
    ...
    value: function callOnSearchCallBack() {
      ...
      this.isLoading = true;
      if (this.onSearch) {
        this.onSearch(this.filterList).then(function (e) {
  ...
  _createClass$2(JBSearchBar, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        className: "jb-search-bar-component"
