//todo:
//1- add defualt value to column config
//2- add serverside fetch list
...
class JBSearchBar extends React.Component {
    ...
    constructor(props){
        super(props);
        this.service = new JBSearchBarService(props)
    }
    componentDidMount(){
        ...
        return(
            <div className="jb-search-bar-component">
                <section className="filter-dynamic-wrapper" ref={this.service.elements.filterDynamicWrapper}>
                    ...
                    {
                        this.service.filterList.map((item,index)=>{
                            return(
                                <div className="item" key="index">
                                <span className="close-icon" onClick={(e)=>this.service.removeFilterFromList(item,index)}>
                    ...
                    <section className="filter-input-section" ref={this.service.elements.filterInputWrapper}>
                        {
                            //if we are in column select mode
                            !this.service.intentColumn && 
                            <div className="column-list-wrapper">
                                <JBSelectBox config={this.service.columnSelectConfig} onChange={(e)=>this.service.onColumnSelected(e)} ></JBSelectBox>
                            </div>
                        ...
                        }
                        {
                            ...
                            <div className="intent-wrapper" >
                                <div class="cancel-btn" onClick={()=>{this.service.cancelIntentColumn()}}>
                                ...
                                <div className="intent-column">
                                    <span>{this.service.intentColumn.caption}:&nbsp;</span>
                                </div>
                                <div className="input-field-wrapper">
                                  <this.InputFieldWrapper column={this.service.intentColumn} value={this.service.intentValue} this={this.service}/>
                                </div>
                                <div onClick={(e)=>this.service.confirmIntent(e)} className={"confirm-btn "+((this.service.intentValue&&this.service.intentValue.isValid)?'active':'')}>
                ...
                <section className="filter-btn" onClick={(e)=>this.service.onFilterBtnClick(e)}>
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="255" cy="255" r="170"></circle>
                        <g ref={this.service.elements.spinnerBox} className="spin-line-group">
                            <rect x="0" y="0" width="512" height="512" />
                            <path ref={this.service.elements.spinnerLine} className="convertable-line" d="M400 400 L 450 450"></path>
                        </g>
                    </svg>
                </section>
            </div>
        ...
        switch(column.type){
            ...
            returnValue = 
                    <div className="list-input">
                        <JBSelectBox value={context.intentValue.value} config={input.column.config} onChange={(e)=>{context.onListValueSelected(e)}} autoFocus={true}/>
                    </div>
            break;
