...
function ta(a, b, d, c) {
  if (null === b || "undefined" === typeof b || sa(a, b, d, c))
    return !0;
  if (c)
    return !1;
  if (null !== d)
...
function za(a, b, d) {
  ...
  if (a === N)
    if (S = !0, a = {
      action: d,
      next: null
    }, null === T && (T = new Map), d = T.get(b), void 0 === d)
      T.set(b, a);
    else {
      for (b = d; null !== b.next; )
        b = b.next;
...
function Sa(a, b, d) {
  function c(c, f) {
    ...
    if ("function" === typeof k.UNSAFE_componentWillMount || "function" === typeof k.componentWillMount)
      if ("function" === typeof k.componentWillMount && "function" !== typeof f.getDerivedStateFromProps && k.componentWillMount(), "function" === typeof k.UNSAFE_componentWillMount && "function" !== typeof f.getDerivedStateFromProps && k.UNSAFE_componentWillMount(), g.length) {
        l = g;
        var m = h;
        g = null;
        h = !1;
...
var Ta = function() {
    ...
    try {
      for (var f = [""],
        ...
        if (e || g.childIndex >= g.children.length) {
          ...
          if ("select" === g.type)
            this.currentSelectValue = null;
          else if (null != g.type && null != g.type.type && g.type.type.$$typeof === z)
    ...
    if ("object" === typeof b && null !== b)
      switch (b.$$typeof) {
        case ia:
          ...
          return "";
        case ja:
          return a = [q.createElement(b.type, p({ref: a.ref}, a.props))], this.stack.push({
            type: null,
            domNamespace: c,
            children: a,
            childIndex: 0,
  ...
  a.prototype.renderDOM = function(a, d, c) {
    ...
    if ("input" === b)
      ...
      this.currentSelectValue = null != e.value ? e.value : e.defaultValue, e = p({}, e, {value: void 0});
    else if ("option" === b) {
    ...
    if (h = e)
      Fa[b] && (null != h.children || null != h.dangerouslySetInnerHTML ? r("137", b, "") : void 0), null != h.dangerouslySetInnerHTML && (null != h.children ? r("60") : void 0, "object" === typeof h.dangerouslySetInnerHTML && "__html" in h.dangerouslySetInnerHTML ? void 0 : r("61")), null != h.style && "object" !== typeof h.style ? r("62", "") : void 0;
    h = e;
    ...
    for (y in h)
      if (Pa.call(h, y)) {
        ...
        if (null != l) {
          ...
          if (m)
            Qa.hasOwnProperty(y) || (n = y, n = ra(n) && null != l ? n + "=" + ('"' + M(l) + '"') : "");
          else {
            m = y;
            n = l;
            l = J.hasOwnProperty(m) ? J[m] : null;
            if (u = "style" !== m)
              u = null !== l ? 0 === l.type : !(2 < m.length) || "o" !== m[0] && "O" !== m[0] || "n" !== m[1] && "N" !== m[1] ? !1 : !0;
