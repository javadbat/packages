...
'use strict';
(function(g, m) {
  "object" === typeof exports && "undefined" !== typeof module ? module.exports = m(require('react'), require('../index')) : "function" === typeof define && define.amd ? define(["react", "react-dom"], m) : g.ReactTestUtils = m(g.React, g.ReactDOM);
})(this, function(g, m) {
  ...
  function K(a) {
    var b = a.alternate;
    if (!b)
      return b = A(a), 3 === b ? l("188") : void 0, 1 === b ? null : a;
    for (var c = a,
        e = b; ; ) {
      var d = c.return,
